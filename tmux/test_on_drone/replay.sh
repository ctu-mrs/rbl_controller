...
input=(
  ...
  'MapReplay' 'rosbag play mapbag --delay 0.1 --loop -r 0.1'

  'SomeTopicReplay' 'rosbag play topicbag --loop -r 0.1'

  'bash' ''

  'tf_connector' 'rosrun tf static_transform_publisher 0 0 0 0 -0.349 0 uav29/point_lio_init map 10
  '
 
  'tf_connector' 'rosrun tf static_transform_publisher 0 0 0 0 -0.349 0 uav29/point_lio_init uav29/map 10
  '

  'tf_connector' 'rosrun tf static_transform_publisher 0 0 0 0 0 0 uav29/point_lio_init uav29/point_lio_odom
  '
  
  'tf_connector' 'rosrun tf static_transform_publisher 0 0 -0.08 0 -0.349 0 /uav29/point_lio_odom /uav29/fcu_odom 10
  '

  'tf_connector' 'rosrun tf static_transform_publisher 0 0 0 0 0 0 /uav29/mapping_origin map 10
  '
